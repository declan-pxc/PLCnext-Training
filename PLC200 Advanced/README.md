...
- The analogue value process data goes from 0..10000 or 0..30000 (have a look at the product downloads > datasheet) - you could either scale for a total of 1440 minutes / day OR convert it to percentage to work out the value.
